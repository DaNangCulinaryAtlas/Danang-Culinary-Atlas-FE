        ...
        >
                ...
                {dish.images && dish.images.length > 0 && !imageError ? (
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                        <div className="text-center">
                            ...
                            <p className="text-sm text-gray-500 mt-2">{t('dishCard.noImage')}</p>
                        </div>
                    </div>
                )}
                ...
                {dish.status === 'UNAVAILABLE' && (
                    <div className="absolute top-3 right-3">
                        <span className="bg-gray-900/80 text-white text-xs font-medium px-3 py-1.5 rounded-full backdrop-blur-sm">
                            {t('dishCard.temporarilyUnavailable')}
                        </span>
                    </div>
                )}
            ...
            <div className="p-4">
                ...
                <div className="mt-3 flex items-center">
                    ...
                    >
                        {dish.status === 'AVAILABLE' ? t('dishCard.available') : t('dishCard.temporarilyUnavailable')}
                    </span>
                </div>
            </div>
        </div>
